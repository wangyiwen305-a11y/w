...
export const HandIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18.5 12.75a3 3 0 11-6 0 3 3 0 016 0z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M18.5 12.75V8.25a3 3 0 10-6 0v4.5" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M18.5 12.75v3.75" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12.5 16.5V3.75a3 3 0 10-6 0v12.75" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12.5 16.5h-6" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.5 16.5v2.25a3 3 0 003 3h4.5a3 3 0 003-3v-2.25" />
    </svg>
);